...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.large_test_image = tk.PhotoImage(file=os.path.join(image_path, "download.png"))
        self.image_icon_image = tk.PhotoImage(file=os.path.join(image_path, "download.png"))

        self.home_image_light = tk.PhotoImage(file=os.path.join(image_path, "download.png"))
        self.home_image_dark = tk.PhotoImage(file=os.path.join(image_path, "download.png"))
        self.chat_image_light = tk.PhotoImage(file=os.path.join(image_path, "download.png"))
        self.chat_image_dark = tk.PhotoImage(file=os.path.join(image_path, "download.png"))
        self.add_user_image_light = tk.PhotoImage(file=os.path.join(image_path, "download.png"))
        self.add_user_image_dark = tk.PhotoImage(file=os.path.join(image_path, "download.png"))
